...
for j=1:d
    ...
    for i=1:n
        ...
        [q1 q2 q3 fu fl ou ol] = quartile(data);
        u = nanmean(data);
        ...
        plot(i-widthl/2+(2*j-1)*widthl/(2*d), u,...
            ...
            'Marker','o',...
            'MarkerEdgeColor','k',...
            'MarkerFaceColor',legendcolors{j,i},...
            'HitTest','off',...
            'Parent',hgg(j));
        hold off;
    end
